...
export default function ProductListScreen() {
        ...
        const [ listFiltered, setListFiltered ] = useState<ProductCartType[]>(productsMock);
    
        useEffect(() => {
            if(value && value !== '') {
                setListFiltered(list.filter(item => item.description.toLowerCase().includes(value.toLowerCase())));
                return;
            }
